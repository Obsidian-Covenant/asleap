...
This is a refactored and modernized edition of [asleap](https://arpon.sourceforge.net/), a tool to actively recover LEAP/PPTP passwords.
...
- ✅ Fixed bug that didn't retrieve passwords from wordlists
- ✅ Reworked md4.c to remove the limit of 32 bytes passwords on wordlists
...
```bash
git clone https://github.com/Obsidian-Covenant/asleap.git
cd asleap
make
sudo install -Dm 755 -t /usr/bin/ asleap genkeys
```
